  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        '/walletPage': (context) => MyHomePage(title: "web3"),
        "/register":(context) => Register(),
        "/recover":(context) => recoverPage(),
        "/loading":(context) => loading(),
        "/login":(context) => Login(),
        "/mnemonic":(context) =>mnemonic(),
        "/makePayment":(context) => MakePayment(paymentAddr: "",paymentList: "",paymentType: "",totalValue: BigInt.zero),
            ...
            Container(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                    ...
                    children: <Widget>[
                      Text("Welcome Back!",style: TextStyle(color: globals.fourthColor,fontSize: 40,fontWeight: FontWeight.w100,)),
                      SizedBox(height: 100,),
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed:(){
                            ...
                            if(myController.text == globals.pass){
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => MyHomePage(title: "Web3")),
                              );
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          TextButton(
                            ...
                            child:
                              Text("import using Secret Recovery Phrase",style: TextStyle(color: Colors.white),),
                          ),
                        ],
                      ),
                      Container(height: 10,),
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed:(){
                            print(myController.text);
                            DEBUG("902f3babddfe6955425f7fb8aab559bab752158b9e76d3001b5c9c2a2b336f18","1234");
