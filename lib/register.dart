    ...
    return Scaffold(
        ...
        body: Container(
          ...
          child: Column(
            children: <Widget>[
              Container(height: 50,),
              Text("Welcome To SuCoin Mobile Wallet",style: TextStyle(color: globals.fourthColor,fontWeight: FontWeight.w200, fontSize: 40),textAlign: TextAlign.center,),
              Container(height: 50,),
              Text("To continue, Please register, or recover a wallet using your 12-word passphrase",style: TextStyle(color: globals.fourthColor,fontWeight: FontWeight.w300, fontSize: 16),textAlign: TextAlign.center,),
              Container(height: 50,),
                    ...
                    Alert(
                        ...
                        content: Column(
                          ...
                          children: <Widget>[
                            ...
                            Center(child: Text("Write down your passphrase, you will not be able to recover it if you lose it.\n",)),
