                    ...
                    child: Column(
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          onPressed:(){
                            if(passphraseController1.text == result[2] && passphraseController2.text==result[6] && passphraseController3.text == result[9]) {
                              changeData(bip39.mnemonicToSeedHex(globals.tempMnemonic), globals.pass);
                              ...
                              Alert(
                                  ...
                                  content: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Center(child: Text("Wrong Passphrase\n",)),
